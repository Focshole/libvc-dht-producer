...
find_path(
  ...
  versioningCompilerProd/producer-utils.hpp
  PATHS ${LibVersioningCompilerProd_INSTALL_PATH}/include
        ${LibVersioningCompilerProd_SOURCE_PATH}/include /usr/local/include
        /usr/include ${CMAKE_EXTRA_INCLUDES}
  NO_DEFAULT_PATH)
...
if(LibVersioningCompilerProd_INCLUDE_DIRS-NOTFOUND)
  ...
  endif(LibVersioningCompilerProd_FIND_REQUIRED)
...
find_library(
  ...
  PATHS ${LibVersioningCompilerProd_INSTALL_PATH}/lib
        ${LibVersioningCompilerProd_BINARY_PATH} /usr/local/lib /usr/lib /lib
...
get_filename_component(LibVersioningCompilerProd_LIBRARY_DIR
                       ${LibVersioningCompilerProd_LIBRARY} PATH)

set(LibVersioningCompilerProd_LIBRARIES ${LibVersioningCompilerProd_LIBRARY}
                                        ${UUID_LIBRARY} ${CMAKE_DL_LIBS})

# Check for libVersioningCompiler
find_package(LibVersioningCompiler REQUIRED)
set(LibVersioningCompilerProd_INCLUDE_DIRS
    ${LibVersioningCompilerProd_INCLUDE_DIRS} ${LIBVC_INCLUDE_DIRS})
set(LibVersioningCompilerProd_LIBRARIES ${LibVersioningCompilerProd_LIBRARIES}
                                        ${LIBVC_LIBRARIES})
set(LibVersioningCompilerProd_LIBRARY_DIR
    ${LibVersioningCompilerProd_LIBRARY_DIR} ${LIBVC_LIB_DIR})
...
set(LibVersioningCompilerProd_INCLUDE_DIRS
    "${LibVersioningCompilerProd_INCLUDE_DIRS}" "${GNUTLS_INCLUDE_DIR}")
set(LibVersioningCompilerProd_LIBRARIES "${LibVersioningCompilerProd_LIBRARIES}"
                                        "${GNUTLS_LIBRARIES}")
...
set(LibVersioningCompilerProd_INCLUDE_DIRS
    "${LibVersioningCompilerProd_INCLUDE_DIRS}" "${LIBZMQ_INCLUDE_DIRS}")
set(LibVersioningCompilerProd_LIBRARIES "${LibVersioningCompilerProd_LIBRARIES}"
                                        "${LIBZMQ_LIBRARIES}")
set(LibVersioningCompilerProd_LIBRARIES ${LibVersioningCompilerProd_LIBRARIES}
                                        "-lzmq")
...
if(LibVersioningCompilerProd_FOUND)
  set(LibVersioningCompilerProd_INCLUDES
      ${LibVersioningCompilerProd_INCLUDE_DIRS})
  set(LibVersioningCompilerProd_LIBS ${LibVersioningCompilerProd_LIBRARIES})
  set(LibVersioningCompilerProd_LIB_DIR
      ${LibVersioningCompilerProd_LIBRARY_DIR})
endif(LibVersioningCompilerProd_FOUND)

message(
  STATUS
    "LibVersioningCompilerProd_INCLUDE_DIRS: ${LibVersioningCompilerProd_INCLUDE_DIRS}"
)
message(
  STATUS
    "LibVersioningCompilerProd_LIBRARIES: ${LibVersioningCompilerProd_LIBRARIES}"
)
